class WritingResponse {
  ...
  WritingResponse({this.status, this.question, this.questionOption});

  WritingResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class QuestionOption {
  ...
  QuestionOption(
      {this.id, this.questionId, this.text, this.createdAt, this.updatedAt});
