...
import 'package:myapplication/listeningExercise.dart';
import 'package:myapplication/network_utils/api.dart';
import 'package:myapplication/reading.dart';
import 'package:myapplication/Reading/readingExercise.dart';
import 'package:myapplication/reading_id.dart';
import 'package:myapplication/Speaking/speakingExercise.dart';
import 'package:myapplication/Writing/writing.dart';
import 'package:myapplication/reading_1.dart';
import 'package:myapplication/try.dart';
import 'package:myapplication/model/ExerciseList_model.dart';
import 'package:myapplication/Writing/writingExercise.dart';
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ListeningSetPage()));
                        },
                        child: Card(
                          color: Colors.orangeAccent,
                          elevation: 2.0,
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => WritingSetPage()));
                        },
                        child: Card(
                          color: Colors.orangeAccent,
                          elevation: 2.0,
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => SpeakingSetPage()));
                        },
                        child: Card(
                          color: Colors.orangeAccent,
                          elevation: 2.0,
