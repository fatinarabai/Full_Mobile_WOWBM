...
class WritingSetPage extends StatefulWidget {
  @override
  _WritingSetPageState createState() => _WritingSetPageState();
}

class _WritingSetPageState extends State<WritingSetPage> {

  Future<ExerciseList> getReadingList() async {
    final url = Network().link("/api/exerciselist/2");
                                        ...
                                        onTap: () {
                                          Navigator.push(
                                              ...
                                              new MaterialPageRoute(
                                                  builder: (context) => WritingPage(id)));
                                        },
                                        child: Text(
                                          "Attempt",
